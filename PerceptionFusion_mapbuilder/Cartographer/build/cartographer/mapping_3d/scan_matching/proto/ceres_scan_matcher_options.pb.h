...
class CeresScanMatcherOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping_3d.scan_matching.proto.CeresScanMatcherOptions) */ {
 public:
  ...
  #if LANG_CXX11
  CeresScanMatcherOptions(CeresScanMatcherOptions&& from) noexcept
    : CeresScanMatcherOptions() {
    *this = ::std::move(from);
  }

  inline CeresScanMatcherOptions& operator=(CeresScanMatcherOptions&& from) noexcept {
  ...
  friend void swap(CeresScanMatcherOptions& a, CeresScanMatcherOptions& b) {
    a.Swap(&b);
  }
  ...
  bool has_only_optimize_yaw() const;
 ...
 private:
  ...
  void set_has_only_optimize_yaw();
  void clear_has_only_optimize_yaw();
  ...
  friend struct protobuf_cartographer_2fmapping_5f3d_2fscan_5fmatching_2fproto_2fceres_5fscan_5fmatcher_5foptions_2eproto::TableStruct;
};
// ===================================================================
