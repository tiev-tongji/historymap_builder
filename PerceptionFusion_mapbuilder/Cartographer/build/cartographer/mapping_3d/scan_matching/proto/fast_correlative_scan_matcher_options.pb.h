...
class FastCorrelativeScanMatcherOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping_3d.scan_matching.proto.FastCorrelativeScanMatcherOptions) */ {
 public:
  ...
  #if LANG_CXX11
  FastCorrelativeScanMatcherOptions(FastCorrelativeScanMatcherOptions&& from) noexcept
    : FastCorrelativeScanMatcherOptions() {
    *this = ::std::move(from);
  }

  inline FastCorrelativeScanMatcherOptions& operator=(FastCorrelativeScanMatcherOptions&& from) noexcept {
  ...
  friend void swap(FastCorrelativeScanMatcherOptions& a, FastCorrelativeScanMatcherOptions& b) {
    a.Swap(&b);
  }
  ...
  bool has_min_rotational_score() const;
  ...
  bool has_linear_xy_search_window() const;
  ...
  bool has_full_resolution_depth() const;
  ...
  bool has_linear_z_search_window() const;
  ...
  bool has_min_low_resolution_score() const;
 ...
 private:
  ...
  void set_has_full_resolution_depth();
  void clear_has_full_resolution_depth();
  void set_has_min_rotational_score();
  void clear_has_min_rotational_score();
  void set_has_min_low_resolution_score();
  void clear_has_min_low_resolution_score();
  void set_has_linear_xy_search_window();
  void clear_has_linear_xy_search_window();
  void set_has_linear_z_search_window();
  void clear_has_linear_z_search_window();
  ...
  friend struct protobuf_cartographer_2fmapping_5f3d_2fscan_5fmatching_2fproto_2ffast_5fcorrelative_5fscan_5fmatcher_5foptions_2eproto::TableStruct;
};
// ===================================================================
...
// optional double min_low_resolution_score = 9;
inline bool FastCorrelativeScanMatcherOptions::has_min_low_resolution_score() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void FastCorrelativeScanMatcherOptions::set_has_min_low_resolution_score() {
  _has_bits_[0] |= 0x00000040u;
}
inline void FastCorrelativeScanMatcherOptions::clear_has_min_low_resolution_score() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void FastCorrelativeScanMatcherOptions::clear_min_low_resolution_score() {
  min_low_resolution_score_ = 0;
  clear_has_min_low_resolution_score();
}
inline double FastCorrelativeScanMatcherOptions::min_low_resolution_score() const {
...
inline void FastCorrelativeScanMatcherOptions::set_min_low_resolution_score(double value) {
