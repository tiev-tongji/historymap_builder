...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, sizeof(CeresScanMatcherOptions)},
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "r.common.proto.CeresSolverOptions"
  };
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                 ...
                 1, 9u, input, this->mutable_occupied_space_weight())));
        } else if (
...
void CeresScanMatcherOptions::SerializeWithCachedSizes(
  ...
  // repeated double occupied_space_weight = 1;
  for (int i = 0, n = this->occupied_space_weight_size(); i < n; i++) {
...
::google::protobuf::uint8* CeresScanMatcherOptions::InternalSerializeWithCachedSizesToArray(
  ...
  target = ::google::protobuf::internal::WireFormatLite::
    WriteDoubleToArray(1, this->occupied_space_weight_, target);
...
// @@protoc_insertion_point(message_byte_size_start:cartographer.mapping_3d.scan_matching.proto.CeresScanMatcherOptions)
  ...
  // repeated double occupied_space_weight = 1;
  {
    ...
    total_size += 1 *
                  ::google::protobuf::internal::FromIntSize(this->occupied_space_weight_size());
...
// @@protoc_insertion_point(class_specific_merge_from_start:cartographer.mapping_3d.scan_matching.proto.CeresScanMatcherOptions)
  ...
  if (cached_has_bits & 15u) {
    ...
    if (cached_has_bits & 0x00000008u) {
      only_optimize_yaw_ = from.only_optimize_yaw_;
    }
...
// optional bool only_optimize_yaw = 5;
bool CeresScanMatcherOptions::has_only_optimize_yaw() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
void CeresScanMatcherOptions::set_has_only_optimize_yaw() {
  _has_bits_[0] |= 0x00000008u;
}
void CeresScanMatcherOptions::clear_has_only_optimize_yaw() {
  _has_bits_[0] &= ~0x00000008u;
}
