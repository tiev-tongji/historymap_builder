...
class SubmapsOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping_3d.proto.SubmapsOptions) */ {
 public:
  ...
  bool has_high_resolution() const;
  ...
  bool has_high_resolution_max_range() const;
 ...
 private:
  void set_has_high_resolution();
  void clear_has_high_resolution();
  void set_has_high_resolution_max_range();
  void clear_has_high_resolution_max_range();
  void set_has_low_resolution();
  void clear_has_low_resolution();
