...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Vector3f_default_instance_);_Quaterniond_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Rigid3f_default_instance_);_Rigid2d_default_instance_._instance.get_mutable()->translation_ = const_cast< ::cartographer::transform::proto::Vector2d*>(
      ::cartographer::transform::proto::Vector2d::internal_default_instance());
  _Rigid2f_default_instance_._instance.get_mutable()->translation_ = const_cast< ::cartographer::transform::proto::Vector2f*>(
      ::cartographer::transform::proto::Vector2f::internal_default_instance());
  _Rigid3d_default_instance_._instance.get_mutable()->translation_ = const_cast< ::cartographer::transform::proto::Vector3d*>(
      ::cartographer::transform::proto::Vector3d::internal_default_instance());
  _Rigid3d_default_instance_._instance.get_mutable()->rotation_ = const_cast< ::cartographer::transform::proto::Quaterniond*>(
      ::cartographer::transform::proto::Quaterniond::internal_default_instance());
  _Rigid3f_default_instance_._instance.get_mutable()->translation_ = const_cast< ::cartographer::transform::proto::Vector3f*>(
      ::cartographer::transform::proto::Vector3f::internal_default_instance());
  _Rigid3f_default_instance_._instance.get_mutable()->rotation_ = const_cast< ::cartographer::transform::proto::Quaternionf*>(
