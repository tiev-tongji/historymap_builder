...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Submap3D_default_instance_);_Submap2D_default_instance_._instance.get_mutable()->local_pose_ = const_cast< ::cartographer::transform::proto::Rigid3d*>(
      ::cartographer::transform::proto::Rigid3d::internal_default_instance());
  _Submap2D_default_instance_._instance.get_mutable()->probability_grid_ = const_cast< ::cartographer::mapping_2d::proto::ProbabilityGrid*>(
      ::cartographer::mapping_2d::proto::ProbabilityGrid::internal_default_instance());
  _Submap3D_default_instance_._instance.get_mutable()->local_pose_ = const_cast< ::cartographer::transform::proto::Rigid3d*>(
      ::cartographer::transform::proto::Rigid3d::internal_default_instance());
  _Submap3D_default_instance_._instance.get_mutable()->high_resolution_hybrid_grid_ = const_cast< ::cartographer::mapping_3d::proto::HybridGrid*>(
      ::cartographer::mapping_3d::proto::HybridGrid::internal_default_instance());
  _Submap3D_default_instance_._instance.get_mutable()->low_resolution_hybrid_grid_ = const_cast< ::cartographer::mapping_3d::proto::HybridGrid*>(
      ::cartographer::mapping_3d::proto::HybridGrid::internal_default_instance());
}
