...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MapBuilderOptions_default_instance_);_MapBuilderOptions_default_instance_._instance.get_mutable()->sparse_pose_graph_options_ = const_cast< ::cartographer::mapping::proto::SparsePoseGraphOptions*>(
...
void MapBuilderOptions::SharedDtor() {
  if (this != internal_default_instance()) delete sparse_pose_graph_options_;
}
...
void MapBuilderOptions::InternalSwap(MapBuilderOptions* other) {
  using std::swap;
  swap(sparse_pose_graph_options_, other->sparse_pose_graph_options_);
...
const ::cartographer::mapping::proto::SparsePoseGraphOptions& MapBuilderOptions::sparse_pose_graph_options() const {
  const ::cartographer::mapping::proto::SparsePoseGraphOptions* p = sparse_pose_graph_options_;
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.MapBuilderOptions.sparse_pose_graph_options)
  return p != NULL ? *p : *reinterpret_cast<const ::cartographer::mapping::proto::SparsePoseGraphOptions*>(
      &::cartographer::mapping::proto::_SparsePoseGraphOptions_default_instance_);
}
