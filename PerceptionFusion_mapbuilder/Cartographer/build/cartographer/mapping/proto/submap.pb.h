...
class Submap2D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Submap2D) */ {
 public:
  ...
  const ::cartographer::mapping_2d::proto::ProbabilityGrid& probability_grid() const;
  ::cartographer::mapping_2d::proto::ProbabilityGrid* mutable_probability_grid();
  ::cartographer::mapping_2d::proto::ProbabilityGrid* release_probability_grid();
  void set_allocated_probability_grid(::cartographer::mapping_2d::proto::ProbabilityGrid* probability_grid);
 ...
 private:
  void set_has_local_pose();
  void clear_has_local_pose();
  void set_has_num_range_data();
  void clear_has_num_range_data();
  void set_has_finished();
  void clear_has_finished();
  void set_has_probability_grid();
  void clear_has_probability_grid();
...
class Submap3D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.Submap3D) */ {
 public:
  ...
  const ::cartographer::mapping_3d::proto::HybridGrid& high_resolution_hybrid_grid() const;
  ::cartographer::mapping_3d::proto::HybridGrid* mutable_high_resolution_hybrid_grid();
  ::cartographer::mapping_3d::proto::HybridGrid* release_high_resolution_hybrid_grid();
  void set_allocated_high_resolution_hybrid_grid(::cartographer::mapping_3d::proto::HybridGrid* high_resolution_hybrid_grid);
  ...
  const ::cartographer::mapping_3d::proto::HybridGrid& low_resolution_hybrid_grid() const;
  ::cartographer::mapping_3d::proto::HybridGrid* mutable_low_resolution_hybrid_grid();
  ::cartographer::mapping_3d::proto::HybridGrid* release_low_resolution_hybrid_grid();
  void set_allocated_low_resolution_hybrid_grid(::cartographer::mapping_3d::proto::HybridGrid* low_resolution_hybrid_grid);
 ...
 private:
  ...
  void set_has_finished();
  void clear_has_finished();
  void set_has_high_resolution_hybrid_grid();
  void clear_has_high_resolution_hybrid_grid();
  void set_has_low_resolution_hybrid_grid();
  void clear_has_low_resolution_hybrid_grid();
...
inline const ::cartographer::mapping_2d::proto::ProbabilityGrid& Submap2D::probability_grid() const {
  const ::cartographer::mapping_2d::proto::ProbabilityGrid* p = probability_grid_;
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.Submap2D.probability_grid)
  return p != NULL ? *p : *reinterpret_cast<const ::cartographer::mapping_2d::proto::ProbabilityGrid*>(
      &::cartographer::mapping_2d::proto::_ProbabilityGrid_default_instance_);
}
...
inline const ::cartographer::mapping_3d::proto::HybridGrid& Submap3D::high_resolution_hybrid_grid() const {
  const ::cartographer::mapping_3d::proto::HybridGrid* p = high_resolution_hybrid_grid_;
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.Submap3D.high_resolution_hybrid_grid)
  return p != NULL ? *p : *reinterpret_cast<const ::cartographer::mapping_3d::proto::HybridGrid*>(
      &::cartographer::mapping_3d::proto::_HybridGrid_default_instance_);
}
...
inline const ::cartographer::mapping_3d::proto::HybridGrid& Submap3D::low_resolution_hybrid_grid() const {
  const ::cartographer::mapping_3d::proto::HybridGrid* p = low_resolution_hybrid_grid_;
