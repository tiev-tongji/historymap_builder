...
class TrajectoryNodeData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.TrajectoryNodeData) */ {
 ...
 private:
  ...
  void set_has_gravity_alignment();
  void clear_has_gravity_alignment();
  void set_has_filtered_gravity_aligned_point_cloud();
  void clear_has_filtered_gravity_aligned_point_cloud();
  void set_has_high_resolution_point_cloud();
  void clear_has_high_resolution_point_cloud();
  void set_has_low_resolution_point_cloud();
  void clear_has_low_resolution_point_cloud();
  void set_has_initial_pose();
  void clear_has_initial_pose();
