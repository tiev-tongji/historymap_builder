...
class CellLimits : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping_2d.proto.CellLimits) */ {
 public:
  CellLimits();
  virtual ~CellLimits();
 ...
 private:
  void set_has_num_x_cells();
  void clear_has_num_x_cells();
  void set_has_num_y_cells();
  void clear_has_num_y_cells();
  ...
  friend struct protobuf_cartographer_2fmapping_5f2d_2fproto_2fcell_5flimits_2eproto::TableStruct;
};
// ===================================================================
