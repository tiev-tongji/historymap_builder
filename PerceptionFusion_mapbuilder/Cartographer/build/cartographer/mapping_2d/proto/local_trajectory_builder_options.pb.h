...
class LocalTrajectoryBuilderOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping_2d.proto.LocalTrajectoryBuilderOptions) */ {
 public:
  ...
  static const int kScansPerAccumulationFieldNumber = 19;
 ...
 private:
  ...
  void set_has_loop_closure_adaptive_voxel_filter_options();
  void clear_has_loop_closure_adaptive_voxel_filter_options();
...
// optional .cartographer.sensor.proto.AdaptiveVoxelFilterOptions loop_closure_adaptive_voxel_filter_options = 20;
inline bool LocalTrajectoryBuilderOptions::has_loop_closure_adaptive_voxel_filter_options() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void LocalTrajectoryBuilderOptions::set_has_loop_closure_adaptive_voxel_filter_options() {
  _has_bits_[0] |= 0x00000020u;
}
inline void LocalTrajectoryBuilderOptions::clear_has_loop_closure_adaptive_voxel_filter_options() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void LocalTrajectoryBuilderOptions::clear_loop_closure_adaptive_voxel_filter_options() {
...
inline const ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions& LocalTrajectoryBuilderOptions::loop_closure_adaptive_voxel_filter_options() const {
...
inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* LocalTrajectoryBuilderOptions::mutable_loop_closure_adaptive_voxel_filter_options() {
...
inline ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* LocalTrajectoryBuilderOptions::release_loop_closure_adaptive_voxel_filter_options() {
...
inline void LocalTrajectoryBuilderOptions::set_allocated_loop_closure_adaptive_voxel_filter_options(::cartographer::sensor::proto::AdaptiveVoxelFilterOptions* loop_closure_adaptive_voxel_filter_options) {
