...
class SparsePoseGraph {
 public:
  ...
  //*****zz 2019-10-14*****//
  // Returns image
  virtual cv::Mat GetImage(double reckonx,double reckony,double yaw, int rows, int cols, int cen_row, int cen_col, float reso,int search_num ,float threshold) = 0;
  //*****zz 2019-10-14*****//
};
