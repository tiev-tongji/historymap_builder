...
//*****zz 2019-10-14*****//
cv::Mat SparsePoseGraph::GetImage(double reckonx,double reckony,double yaw, int rows, int cols, int cen_row, int cen_col, float reso,int search_num ,float threshold) 
{
    Mat test;
    return test;
}
