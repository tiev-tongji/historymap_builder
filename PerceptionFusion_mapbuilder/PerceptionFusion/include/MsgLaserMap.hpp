...
#ifndef __MsgLaserMap_hpp__
#define __MsgLaserMap_hpp__
...
int MsgLaserMap::encode(void* buf, uint32_t offset, uint32_t maxlen) const
{
    uint32_t pos = 0;
    int thislen;
...
int MsgLaserMap::decode(const void* buf, uint32_t offset, uint32_t maxlen)
{
    uint32_t pos = 0;
    int thislen;
...
uint32_t MsgLaserMap::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t MsgLaserMap::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* MsgLaserMap::getTypeName()
{
    return "MsgLaserMap";
}

int MsgLaserMap::_encodeNoHash(void* buf, uint32_t offset, uint32_t maxlen) const
{
    uint32_t pos = 0;
    int thislen;
...
int MsgLaserMap::_decodeNoHash(const void* buf, uint32_t offset, uint32_t maxlen)
{
    uint32_t pos = 0;
    int thislen;
...
uint32_t MsgLaserMap::_getEncodedSizeNoHash() const
{
    uint32_t enc_size = 0;
...
uint64_t MsgLaserMap::_computeHash(const __zcm_hash_ptr*)
{
    uint64_t hash = (uint64_t)0x36ab4e86007ad0c9LL;
